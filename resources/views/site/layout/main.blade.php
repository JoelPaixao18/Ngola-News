...
<html class="no-js" data-theme="light" lang="en">
  ...
  <head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="{{ url('site/assets/img/favicons/android-icon-192x192.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ url('site/assets/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ url('site/assets/img/favicons/favicon-96x96.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('site/assets/img/favicons/favicon-16x16.png')}}">
