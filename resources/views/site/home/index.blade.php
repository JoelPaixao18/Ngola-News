...
@section('content-home')
    <div class="th-hero-wrapper hero-1" id="hero">
      <div class="hero-slider-1 th-carousel" data-fade="true" data-slide-show="1" data-md-slide-show="1" data-adaptive-height="true">
        <div class="th-hero-slide">
          <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_1.jpg"></div>
          <div class="container">
            <div class="blog-bg-style1">
              <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html" class="category">Gadget</a>
              <h3 data-ani="slideinup" data-ani-delay="0.3s" class="box-title-50">
                <a class="hover-line" href="blog-details.html">Tech made simple, Your Everyday Made extraordinary.</a>
              </h3>
        ...
        <div class="th-hero-slide">
          <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_2.jpg"></div>
          <div class="container">
            <div class="blog-bg-style1">
              <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html" class="category">Robotic</a>
              <h3 data-ani="slideinup" data-ani-delay="0.3s" class="box-title-50">
                <a class="hover-line" href="blog-details.html">Embracing Tech: Elevating Everyday Experiences</a>
              </h3>
              <div class="blog-meta" data-ani="slideinup" data-ani-delay="0.5s">
                <a href="author.html">
                  <i class="far fa-user"></i>By - Tnews
        ...
        <div class="th-hero-slide">
          <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_3.jpg"></div>
          <div class="container">
            <div class="blog-bg-style1">
              <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html" class="category">Tech</a>
              <h3 data-ani="slideinup" data-ani-delay="0.3s" class="box-title-50">
                <a class="hover-line" href="blog-details.html">Unraveling Innovation: Simplifying Your Daily Life</a>
              </h3>
              <div class="blog-meta" data-ani="slideinup" data-ani-delay="0.5s">
                <a href="author.html">
                  <i class="far fa-user"></i>By - Tnews
        ...
        <div class="th-hero-slide">
          <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_4.jpg"></div>
          <div class="container">
            <div class="blog-bg-style1">
              <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html" class="category">Gadget</a>
              <h3 data-ani="slideinup" data-ani-delay="0.3s" class="box-title-50">
                <a class="hover-line" href="blog-details.html">Transforming Daily Routines with Tech Wonders</a>
              </h3>
              <div class="blog-meta" data-ani="slideinup" data-ani-delay="0.5s">
                <a href="author.html">
                  <i class="far fa-user"></i>By - Tnews
        ...
        <div class="th-hero-slide">
          <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_5.jpg"></div>
          <div class="container">
            <div class="blog-bg-style1">
              <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html" class="category">VR Glass</a>
              <h3 data-ani="slideinup" data-ani-delay="0.3s" class="box-title-50">
                <a class="hover-line" href="blog-details.html">Revolutionizing Your Day: Techs Extraordinary Touch</a>
              </h3>
              <div class="blog-meta" data-ani="slideinup" data-ani-delay="0.5s">
                <a href="author.html">
                  <i class="far fa-user"></i>By - Tnews
        ...
        <div class="th-hero-slide">
          <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_6.jpg"></div>
          <div class="container">
            <div class="blog-bg-style1">
              <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html" class="category">Gadget</a>
              <h3 data-ani="slideinup" data-ani-delay="0.3s" class="box-title-50">
                <a class="hover-line" href="blog-details.html">Tech Marvels: Elevate Your Everyday to Extraordinary</a>
              </h3>
              <div class="blog-meta" data-ani="slideinup" data-ani-delay="0.5s">
                <a href="author.html">
                  <i class="far fa-user"></i>By - Tnews
        ...
        <div class="row th-carousel" id="blog-slide7" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="2">
          <div class="col-sm-6 col-lg-4 col-xl-3 dark-theme">
            <div class="blog-style3">
              <div class="blog-img">
                <img src="assets/img/blog/blog_5_2_21.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Laptop</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Tech on the go, laptop Redefines mobility.</a>
                </h3>
                <div class="blog-meta">
                  <a href="author.html">
                    <i class="far fa-user"></i>By - Tnews
          ...
          <div class="col-sm-6 col-lg-4 col-xl-3 dark-theme">
            <div class="blog-style3">
              <div class="blog-img">
                <img src="assets/img/blog/blog_5_2_22.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Tech</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Tech brilliance, where Possibilities unfold.</a>
                </h3>
                <div class="blog-meta">
                  <a href="author.html">
                    <i class="far fa-user"></i>By - Tnews
          ...
          <div class="col-sm-6 col-lg-4 col-xl-3 dark-theme">
            <div class="blog-style3">
              <div class="blog-img">
                <img src="assets/img/blog/blog_5_2_23.jpg" alt="blog image">
              </div>
              <div class="blog-content">
          ...
          <div class="col-sm-6 col-lg-4 col-xl-3 dark-theme">
            <div class="blog-style3">
              <div class="blog-img">
                <img src="assets/img/blog/blog_5_2_24.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Camera</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Gadgets: Simplify life, elevate your experience.</a>
                </h3>
                <div class="blog-meta">
                  <a href="author.html">
                    <i class="far fa-user"></i>By - Tnews
          ...
          <div class="col-sm-6 col-lg-4 col-xl-3 dark-theme">
            <div class="blog-style3">
              <div class="blog-img">
                <img src="assets/img/blog/blog_5_2_25.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Gadget</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">New gadget can unblock some of your future.</a>
                </h3>
                <div class="blog-meta">
                  <a href="author.html">
                    <i class="far fa-user"></i>By - Tnews
    ...
    <div class="container space-top">
      <a href="https://themeforest.net/user/themeholy/portfolio">
        <img class="light-img" src="assets/img/ads/ads_5.jpg" alt="ads">
        <img class="dark-img" src="assets/img/ads/ads_5_dark.jpg" alt="ads">
      </a>
    </div>
    <section class="space">
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="row gy-4">
              <div class="col-xl-12 col-sm-6">
                <div class="blog-style1">
                  <div class="blog-img">
                    <img src="assets/img/blog/blog_1_37.jpg" alt="blog image">
                    <a data-theme-color="#6234AC" href="blog.html" class="category">Gadget</a>
                  </div>
                  <h3 class="box-title-22">
                    <a class="hover-line" href="blog-details.html">Where style meets innovation seamlessly.</a>
                  </h3>
                  <div class="blog-meta">
                    <a href="author.html">
                      <i class="far fa-user"></i>By - Tnews
              ...
              <div class="col-xl-12 col-sm-6">
                <div class="blog-style1">
                  <div class="blog-img">
                    <img src="assets/img/blog/blog_1_38.jpg" alt="blog image">
                    <a data-theme-color="#6234AC" href="blog.html" class="category">Monitor</a>
                  </div>
                  <h3 class="box-title-22">
                    <a class="hover-line" href="blog-details.html">Embrace the future, gadgets that amazing.</a>
                  </h3>
                  <div class="blog-meta">
                    <a href="author.html">
                      <i class="far fa-user"></i>By - Tnews
          ...
          <div class="col-xl-9 mt-4 mt-xl-0">
            <div class="dark-theme space-40">
              <div class="blog-style3">
                <div class="blog-img">
                  <img src="assets/img/blog/blog_5_14.jpg" alt="blog image">
                </div>
                <div class="blog-content">
                  <a data-theme-color="#6234AC" href="blog.html" class="category">Technology</a>
                  <h3 class="box-title-40">
                    <a class="hover-line" href="blog-details.html">Tech brilliance, forging a path to a smarter, Connected universe.</a>
                  </h3>
                  <div class="blog-meta">
                    <a href="author.html">
                      <i class="far fa-user"></i>By - Tnews
    ...
    <section class="bg-fixed dark-theme" data-bg-src="assets/img/blog/blog_full_1.jpg" data-overlay="black" data-opacity="7">
      <div class="container">
        <div class="blog-bg-style1 row">
          <div class="col-md-9 col-sm">
            <a data-theme-color="#6234AC" href="blog.html" class="category">Technology</a>
            <h3 class="box-title-50">
              <a class="hover-line" href="blog-details.html">From vision to reality, technology Pioneers progress</a>
            </h3>
            <div class="blog-meta">
              <a href="author.html">
                <i class="far fa-user"></i>By - Tnews
        ...
        <div class="row gy-24 filter-active mbn-24">
          <div class="col-xl-4 col-md-6 filter-item cat1">
            <div class="blog-style3 dark-theme">
              <div class="blog-img">
                <img src="assets/img/blog/blog_5_2_26.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Gadget</a>
                <h3 class="box-title-24">
                  <a class="hover-line" href="blog-details.html">Your life, upgraded - gadgets Make it extraordinary</a>
                </h3>
                <div class="blog-meta">
                  <a href="author.html">
                    <i class="far fa-user"></i>By - Tnews
          ...
          <div class="col-xl-4 col-md-6 filter-item cat1">
            <div class="blog-style2">
              <div class="blog-img img-big">
                <img src="assets/img/blog/blog_3_3_1.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Gadget</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Gadgets Elevating lifes moments, effortlessly.</a>
                </h3>
                <div class="blog-meta">
                  <a href="blog.html">
                    <i class="fal fa-calendar-days"></i>15 Mar, 2025
          ...
          <div class="col-xl-4 col-md-6 filter-item cat2">
            <div class="blog-style2">
              <div class="blog-img img-big">
                <img src="assets/img/blog/blog_3_3_2.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Phone</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Efficiency meets style - embrace gadgets charm</a>
                </h3>
                <div class="blog-meta">
                  <a href="blog.html">
          ...
          <div class="col-xl-4 col-md-6 filter-item cat2">
            <div class="blog-style2">
              <div class="blog-img img-big">
                <img src="assets/img/blog/blog_3_3_3.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Phone</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Upgrade living, unleash gadget magic now.</a>
                </h3>
                <div class="blog-meta">
                  <a href="blog.html">
                    <i class="fal fa-calendar-days"></i>18 Mar, 2025
          ...
          <div class="col-xl-4 col-md-6 filter-item cat3">
            <div class="blog-style2">
              <div class="blog-img img-big">
                <img src="assets/img/blog/blog_3_3_4.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Electronic</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Smart tech, brighter future embrace gadgets.</a>
                </h3>
                <div class="blog-meta">
                  <a href="blog.html">
                    <i class="fal fa-calendar-days"></i>15 Mar, 2025
          ...
          <div class="col-xl-4 col-md-6 filter-item cat3">
            <div class="blog-style2">
              <div class="blog-img img-big">
                <img src="assets/img/blog/blog_3_3_5.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Electronic</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Tech wonders, where possibilities gadgets.</a>
                </h3>
                <div class="blog-meta">
                  <a href="blog.html">
          ...
          <div class="col-xl-4 col-md-6 filter-item cat1">
            <div class="blog-style2">
              <div class="blog-img img-big">
                <img src="assets/img/blog/blog_3_3_6.jpg" alt="blog image">
              </div>
              <div class="blog-content">
                <a data-theme-color="#6234AC" href="blog.html" class="category">Gadget</a>
                <h3 class="box-title-20">
                  <a class="hover-line" href="blog-details.html">Where innovation meets everyday brilliance.</a>
                </h3>
                <div class="blog-meta">
                  <a href="blog.html">
                    <i class="fal fa-calendar-days"></i>26 Mar, 2025
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-8">
              ...
              <div class="dark-theme img-overlay2 space-40">
                <div class="blog-style3">
                  ...
                  <div class="blog-content">
                    <a data-theme-color="#6234AC" href="blog.html" class="category">Technology</a>
                    <h3 class="box-title-40">
                      <a class="hover-line" href="blog-details.html">Tech Unleash possibilities, shape a brighter future.</a>
                    </h3>
                    <div class="blog-meta">
                      <a href="author.html">
                        <i class="far fa-user"></i>By - Tnews
            ...
            <div class="space">
              <a href="https://themeforest.net/user/themeholy/portfolio">
                <img class="w-100 light-img" src="assets/img/ads/ads_6.jpg" alt="ads">
                <img class="w-100 dark-img" src="assets/img/ads/ads_6_dark.jpg" alt="ads">
              </a>
            </div>
              ...
              <div class="mb-4">
                <div class="blog-style4">
                  ...
                  <div class="blog-content">
                    <a data-theme-color="#6234AC" href="blog.html" class="category">Technology</a>
                    <h3 class="box-title-22">
                      <a class="hover-line" href="blog-details.html">where possibilities blossom, and lives thrive with technology.</a>
                    </h3>
                    <div class="blog-meta">
                      <a href="author.html">
                        <i class="far fa-user"></i>By - Tnews
              ...
              <div class="mb-4">
                <div class="blog-style4">
                  ...
                  <div class="blog-content">
                    <a data-theme-color="#6234AC" href="blog.html" class="category">Robotic</a>
                    <h3 class="box-title-22">
                      <a class="hover-line" href="blog-details.html">Robotics empowers progress, reshaping industries with ingenuity.</a>
                    </h3>
                    <div class="blog-meta">
                      <a href="author.html">
                        <i class="far fa-user"></i>By - Tnews
              ...
              <div class="mb-4">
                <div class="blog-style4">
                  ...
                  <div class="blog-content">
                    ...
                    <h3 class="box-title-22">
                      <a class="hover-line" href="blog-details.html">where gadgets enhance your life effortlessly and beautifully.</a>
                    </h3>
                    <div class="blog-meta">
                      <a href="author.html">
                        <i class="far fa-user"></i>By - Tnews
              ...
              <div class="mb-4">
                <div class="blog-style4">
                  ...
                  <div class="blog-content">
                    <a data-theme-color="#6234AC" href="blog.html" class="category">VR Glass</a>
                    <h3 class="box-title-22">
                      <a class="hover-line" href="blog-details.html">Elevate life, redefine human potential with virtual reality.</a>
                    </h3>
                    <div class="blog-meta">
                      <a href="author.html">
                        <i class="far fa-user"></i>By - Tnews
            ...
            <div class="sidebar-area">
              <div class="widget">
                <div class="widget-ads">
                  <a href="https://themeforest.net/user/themeholy/portfolio">
                    <img class="w-100 light-img" src="assets/img/ads/siderbar_ads_3.jpg" alt="ads">
                    <img class="w-100 dark-img" src="assets/img/ads/siderbar_ads_3_dark.jpg" alt="ads">
                  </a>
                </div>
              </div>
              <div class="widget">
              ...
              <div class="widget newsletter-widget3" data-bg-src="assets/img/bg/line_bg_1.png">
                <div class="mb-4">
