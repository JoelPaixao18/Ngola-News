...
@section('content-home')
    <div class="th-hero-wrapper hero-1" id="hero">
        <div class="hero-slider-1 th-carousel" data-fade="true" data-slide-show="1" data-md-slide-show="1"
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_1.jpg">
                </div>
                <div class="container">
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_2.jpg">
                </div>
                <div class="container">
                    <div class="blog-bg-style1">
                        <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html"
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_3.jpg">
                </div>
                <div class="container">
                    <div class="blog-bg-style1">
                        <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html"
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="black" data-opacity="6" data-bg-src="assets/img/hero/hero_bg_1_4.jpg">
                </div>
                <div class="container">
                    <div class="blog-bg-style1">
                        <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html"
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="black" data-opacity="6"
                    data-bg-src="assets/img/hero/hero_bg_1_5.jpg"></div>
                <div class="container">
                    <div class="blog-bg-style1">
                        <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html"
            ...
            <div class="th-hero-slide">
                <div class="th-hero-bg" data-overlay="black" data-opacity="6"
                    data-bg-src="assets/img/hero/hero_bg_1_6.jpg"></div>
                <div class="container">
                    <div class="blog-bg-style1">
                        <a data-theme-color="#6234AC" data-ani="slideinup" data-ani-delay="0.1s" href="blog.html"
                            class="category">Gadget</a>
    ...
    <section class="bg-fixed dark-theme" data-bg-src="assets/img/blog/blog_full_1.jpg" data-overlay="black"
        data-opacity="7">
        <div class="container">
                        ...
                        <div class="widget">
                            <div class="widget-ads">
                                <a href="https://themeforest.net/user/themeholy/portfolio">
                                    ...
                                    <img class="w-100 dark-img" src="assets/img/ads/siderbar_ads_3_dark.jpg"
                                        alt="ads">
                                </a>
                            </div>
                        </div>
