@extends('admin.proposal.proposalEdit.layout.main')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" data-select2-selector="user">
                                    <option value="1" data-user="1" selected>Alexandra Della - Website design and
                                        development</option>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-4">
                                    ...
                                    <input class="form-control" id="startDate" value="26/03/2023"
                                        placeholder="Pick start date ">
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <label class="form-label">Due <span class="text-danger">*</span></label>
                                    <input class="form-control" id="dueDate" value="30/03/2023"
                            ...
                            <div class="mb-0">
                                ...
                                <select class="form-select form-control" data-select2-selector="user" multiple>
                                    ...
                                    <option value="erna.serpa@outlook.com" data-user="6" selected>erna.serpa@outlook.com
                                    </option>
                                    ...
                                    <option value="mar.audrey@gmail.com" data-user="11" selected>mar.audrey@gmail.com
                                    </option>
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <select class="form-select form-control" data-select2-selector="user" multiple>
                                    ...
                                    <option value="john.deo@outlook.com" data-user="2">john.deo@outlook.com</option>
                                    <option value="green.cutte@outlook.com" data-user="3" selected>
                                        green.cutte@outlook.com</option>
                                    <option value="nancy.elliot@outlook.com" data-user="4">nancy.elliot@outlook.com
                                    </option>
                                    <option value="mar.audrey@gmail.com" data-user="5">mar.audrey@gmail.com</option>
                                    <option value="erna.serpa@outlook.com" data-user="6" selected>erna.serpa@outlook.com
                                            ...
                                            <tbody>
                                                <tr id="addr0">
                                                    ...
                                                    <td><input type="text" name="product[]" placeholder="Product Name"
                                                            class="form-control" value="Website design and development">
                                                    </td>
                                                    <td><input type="number" name="qty[]" placeholder="Qty"
                                                            class="form-control qty" step="1" min="1"
                                                            value="1"></td>
                                                    <td><input type="number" name="price[]" placeholder="Unit Price"
                                                            class="form-control price" step="1.00" min="1"
                                                            value="250.00"></td>
                                                    <td><input type="number" name="total[]" placeholder="0.00"
                                                            class="form-control total" readonly="" value="250.00">
                                                    </td>
                                                </tr>
                                                <tr id="addr1">
                                                    <td>2</td>
                                                    <td><input type="text" name="product[]" placeholder="Product Name"
                                                            class="form-control"
                                                            value="Search engine optimization (SEO) optimization"></td>
                                                    <td><input type="number" name="qty[]" placeholder="Qty"
                                                            class="form-control qty" step="1" min="1"
                                                            value="2"></td>
                                                    <td><input type="number" name="price[]" placeholder="Unit Price"
                                                            ...
                                                            value="300.00"></td>
                                                    <td><input type="number" name="total[]" placeholder="0.00"
                                                            class="form-control total" readonly="" value="600.00">
                                                    </td>
                                                </tr>
                                                <tr id="addr2">
                                                    <td>3</td>
                                            ...
                                            <tbody>
                                                <tr class="single-item">
                                                    ...
                                                    <td class="w-25"><input type="number" name="sub_total"
                                                            ...
                                                            id="sub_total" readonly="" value="850.00"></td>
                                                </tr>
                                                <tr class="single-item">
