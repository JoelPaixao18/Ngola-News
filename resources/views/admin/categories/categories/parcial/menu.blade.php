            ...
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a class="nxl-link"
                                href="{{ route('admin.category.show', ['category' => $category]) }}">Category
                                View</a>
                        </li>
                        <li class="nxl-item"><a class="nxl-link"
                                href="{{ route('admin.category.edit', ['category' => $category]) }}">Category
                                Edit</a>
                        </li>
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a class="nxl-link" href="{{ route('admin.news.create') }}">News
                                Create</a>
                        </li>
                        {{--
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a class="nxl-link" href="/customers/customersView">Customers View</a>
                        </li>
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a class="nxl-link" href="/projects/projectsCreate">Projects Create</a>
                        </li>
                    </ul>
                </li>
                --}}
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item nxl-hasmenu">
                            ...
                            <ul class="nxl-submenu">
                                ...
                                <li class="nxl-item"><a class="nxl-link" href="/Login/authLoginMinimal">Minimal</a>
                                </li>
                                <li class="nxl-item"><a class="nxl-link" href="/Login/authLoginCreative">Creative</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nxl-item nxl-hasmenu">
                            ...
                            <ul class="nxl-submenu">
                                <li class="nxl-item"><a class="nxl-link" href="/Register/authRegisterCover">Cover</a>
                                </li>
                                <li class="nxl-item"><a class="nxl-link"
                        ...
                        <li class="nxl-item nxl-hasmenu">
                            ...
                            <ul class="nxl-submenu">
                                ...
                                <li class="nxl-item"><a class="nxl-link" href="/Error/auth404creative">Creative</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nxl-item nxl-hasmenu">
                            ...
                            <ul class="nxl-submenu">
                                ...
                                <li class="nxl-item"><a class="nxl-link" href="/Reset/authResetMinimal">Minimal</a>
                                </li>
                                <li class="nxl-item"><a class="nxl-link" href="/Reset/authResetCreative">Creative</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nxl-item nxl-hasmenu">
                            ...
                            <ul class="nxl-submenu">
                                <li class="nxl-item"><a class="nxl-link" href="/VerifyOTP/authVerifyCover">Cover</a>
                                </li>
                                <li class="nxl-item"><a class="nxl-link"
                ...
                <li class="nxl-item nxl-hasmenu">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item"><a class="nxl-link" href="/Help/help-knowledgebase">KnowledgeBase</a>
                        </li>
