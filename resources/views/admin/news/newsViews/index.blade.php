                        ...
                        <ul class="nav flex-column nxl-content-sidebar-item">
                            <li
                                ...
                                <a href="javascript:void(0);">
                                    <span class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        title="Add New"> <i class="feather-plus"></i> </span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0);">
                            ...
                            <div class="action-list-items">
                                ...
                                <div class="dropdown">
                                    <a href="javascript:void(0)" class="d-flex" data-bs-toggle="dropdown"
                                        ...
                                        <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                            data-bs-trigger="hover" title="Tags">
                                ...
                                <div class="dropdown">
                                    <a href="javascript:void(0)" class="d-flex" data-bs-toggle="dropdown"
                                        data-bs-offset="0,22" data-bs-auto-close="outside" aria-expanded="false">
                                        <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                            data-bs-trigger="hover" title="Labels">
                            ...
                            <div class="hstack gap-2">
                                    ...
                                    <form class="search-form" style="display: none">
                                        <div class="search-form-inner">
                                            <a href="javascript:void(0)" class="search-form-close-toggle">
                                                <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                                    data-bs-trigger="hover" title="Back">
                                ...
                                <div class="hstack d-none d-sm-flex">
                                    <a href="javascript:void(0)" class="d-flex me-1">
                                        <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                            data-bs-trigger="hover" title="Previous">
                                            <i class="feather-chevron-left"></i>
                                        </div>
                                    </a>
                                    <a href="javascript:void(0)" class="d-flex me-1">
                                        <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                            data-bs-trigger="hover" title="Next">
                    ...
                    <div class="content-area-body p-0">
                        <div class="single-items">
                            ...
                            <div class="d-flex align-items-center justify-content-end wd-150 gap-3 item-data">
                                <div class="fs-11 fw-medium text-muted text-uppercase d-none d-sm-block item-time">26 May,
                                    2023</div>
                            ...
                            <div class="d-flex align-items-center gap-4 w-100 item-info" data-view-toggle="details">
                                ...
                                <a href="javascript:void(0)" class="d-none d-md-block">
                                    <div class="w-100 text-truncate-1-line item-desc">
                                        ...
                                        <i class="feather-link-2 fs-12"></i>
                                        <span class="ms-3">Flatlogic Contact Form: I am requesting to submit a
                                            template</span>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div
                            class="p-4 bg-white d-flex align-items-center justify-content-center justify-content-md-between">
                            <div class="content-sidebar-footer wd-300 d-none d-md-block">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <h2 class="fs-11 tx-spacing-1 mb-0">Storage</h2>
                                    <div class="fs-11 text-muted">43.5GB used of <span
                                            class="fw-bold text-dark">100GB</span></div>
                                </div>
                    ...
                    <div class="items-details" data-scrollbar-target="#psScrollbarInit">
                        <div class="items-details-header bg-white sticky-top">
                            <div class="d-flex align-items-center">
                                <div class="avatar-text avatar-md item-info-close" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" title="Back">
                                    <i class="feather-arrow-left"></i>
                                </div>
                                <span class="vr mx-4"></span>
                                <div class="d-flex align-items-center">
                                    <h4 class="fw-bold mb-0 text-dark text-truncate-1-line">[Update] Latest news updates on
                                        your subscribed channel</h4>
                            ...
                            <div class="ms-4 d-none d-md-flex gap-1">
                                <a href="javascript:void(0)" class="d-flex me-1 successAlertMessage">
                                    <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Print">
                                        <i class="feather-printer"></i>
                                    </div>
                                </a>
                                <a href="javascript:void(0)" class="d-flex me-1 successAlertMessage">
                                    <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Snooze">
                                        <i class="feather-bell"></i>
                                    </div>
                                </a>
                                <a href="javascript:void(0)" class="d-flex me-1 successAlertMessage">
                                    <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Favorite">
                                        <i class="feather-star"></i>
                                    </div>
                                </a>
                                <a href="javascript:void(0)" class="d-flex me-1 successAlertMessage">
                                    <div class="avatar-text avatar-md" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Flag">
                                ...
                                <div class="accordion-item">
                                    <div class="accordion-header" id="headingOne">
                                        <div class="accordion-button collapsed" role="button"
                                            ...
                                            <div class="d-none d-sm-flex align-items-center gap-3 position-absolute"
                                                style="top: 25px; right: 50px">
                                                <div
                                                    class="fs-10 fw-medium text-muted text-uppercase item-time d-none d-sm-block">
                                                    27 May, 2023</div>
                                                <div class="c-pointer" data-bs-toggle="collapse"
                                                    data-bs-target="#collapseMessageEditor">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <br>
                                            <p class="mb-0">Looking forward to hearing from you!</p>
                                            <div class="fs-12">Thanks by, <a href="javascript:void(0);">Marianne
                                                    Audrey</a></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                ...
                                                dolore magnam aliquam quaerat voluptatem. dolore magnam aliquam quaerat
                                                voluptatem. Quis autem vel eum iure reprehenderit qui pariatur?</p>
                                            <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et
                                                dolore magnam aliquam quaerat voluptatem. Quis autem vel eum iure
                                                reprehenderit qui pariatur? adipisci velit, sed quia non numquam eius modi
                                                tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Quis
                                                autem vel eum iure reprehenderit qui pariatur?</p>
                                            <p>
                                                Neque porro quisquam est,
                                                <strong>
                                                    <em>qui dolorem ipsum quia dolor sit amet, consectetur, adipisci
                                                        velit</em>
                                                </strong>
                                                , sed quia non numquam eius modi tempora incidunt ut consectetur, adipisci
                                                velit sed quia non numquam eius modi tempora incidunt ut labore et dolore
                                                magnam aliquam quaerat voluptatem.Quis autem vel eum iure reprehenderit qui
                                                pariatur?
                                            </p>
                                            <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                                                adipisci velit, sed quia non numquam eius modi tempora incidunt
                                                utconsectetur, adipisci velit, sed quia non numquam eius modi tempora
                                                incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Quis autem
                                                vel eum iurereprehenderit qui pariatur?</p>
                                            <br>
                                            <p class="mb-0">Looking forward to hearing from you!</p>
                                            <div class="fs-12">Thanks by, <a href="javascript:void(0);">Alexandra
                                                    Della</a></div>
                                            <hr class="border-dashed">
                                            <!--! BEGIN: [attachment-section] !-->
                                            <div class="attachment-section">
                                                <p class="text-muted mb-4"><i
                                                        class="bi bi-paperclip fs-12"></i><span>Attachments</span>
                                                    <span>(5+) -</span> <a href="javascript:void(0)"
                                                        class="font-bld file-download">Download all</a> | <a
                                                        href="javascript:void(0);" class="font-bld">View all</a></p>
                                                <div class="row">
                                                    <!--! BEGIN: [single-attachment-item] !-->
                                                    <div class="col-xxl-6 col-xl-12 col-md-6">
                                                        <div
                                                            class="mb-4 text-dark d-flex align-items-center justify-content-between border rounded-3">
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"
                                                                    class="p-3 d-flex align-items-center border-end wd-70 ht-70">
                                                                    <img src="assets/images/file-icons/zip.png"
                                                                        class="img-fluid" alt="image">
                                                                </a>
                                                                <div class="d-block ms-3">
                                                                    <a href="javascript:void(0)"
                                                                        class="fs-13 font-bld text-truncate-1-line">Projects.zip</a>
                                                                    <small class="fw-normal text-muted">40.65/MB</small>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center p-3 border-start">
                                                                <a href="javascript:void(0)"
                                                                    class="avatar-text file-download">
                                                    ...
                                                    <div class="col-xxl-6 col-xl-12 col-md-6">
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"
                                                                    class="p-3 d-flex align-items-center border-end wd-70 ht-70">
                                                                    <img src="assets/images/file-icons/png.png"
                                                                        class="img-fluid" alt="image">
                                                                </a>
                                                                <div class="d-block ms-3">
                                                                    <a href="javascript:void(0)"
                                                                        class="fs-13 font-bld text-truncate-1-line">Document.png</a>
                                                    ...
                                                    <div class="col-xxl-6 col-xl-12 col-md-6">
                                                        <div
                                                            class="mb-4 mb-xxl-0 mb-xl-4 mb-md-0 text-dark d-flex align-items-center justify-content-between border rounded-3">
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"
                                                                    class="p-3 d-flex align-items-center border-end wd-70 ht-70">
                                                                    <img src="assets/images/file-icons/psd.png"
                                                                        class="img-fluid" alt="image">
                                                                </a>
                                                                <div class="d-block ms-3">
                                                                    <a href="javascript:void(0)"
                                                                        class="fs-13 font-bld text-truncate-1-line">Document.psd</a>
                                                    ...
                                                    <div class="col-xxl-6 col-xl-12 col-md-6">
                                                        <div
                                                            class="text-dark d-flex align-items-center justify-content-between border rounded-3">
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:void(0);"
                                                                    class="p-3 d-flex align-items-center border-end wd-70 ht-70">
                                                                    <img src="assets/images/file-icons/pdf.png"
                                                                        class="img-fluid" alt="image">
                                                                </a>
                                                                <div class="d-block ms-3">
                                                                    <a href="javascript:void(0)"
                                                                        class="fs-13 font-bld text-truncate-1-line">Photos.pdf</a>
                        ...
                        <div class="items-details-footer mail-action-editor m-4 border border-top-0 rounded-3">
                            <div class="p-0 ht-400 border-top position-relative editor-section"
                                data-scrollbar-target="#psScrollbarInit">
                                <div class="position-relative border-bottom">
                                    <div class="px-2 d-flex align-items-center">
                                        <div class="p-0 w-100">
                                            <input class="form-control border-0 text-dark" name="tomailcontent"
                                                placeholder="TO">
                                        </div>
                                    </div>
                                    <a href="javascript:void(0)"
                                        class="position-absolute top-50 end-0 translate-middle badge bg-gray-200 border fw-semibold text-uppercase text-dark rounded-pill c-pointer z-index-100"
                                        id="ccbccToggleContent"><span data-bs-toggle="tooltip" data-bs-trigger="hover"
                                ...
                                <div class="border-bottom" id="ccbccToggleContentFileds" style="display: none">
                                    <div class="px-2 w-100 d-flex align-items-center border-bottom">
                                        <input class="form-control border-0 text-dark" name="ccmailcontent"
                                            placeholder="CC">
                                    </div>
                                    <div class="px-2 w-100 d-flex align-items-center">
                                        <input class="form-control border-0 text-dark" name="bccmailcontent"
                                            placeholder="BCC">
                                    </div>
                                </div>
                            ...
                            <div class="px-4 py-3 d-flex align-items-center justify-content-between border-top">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="dropdown d-none d-sm-block">
                                        <a href="javascript:void(0)" data-bs-toggle="dropdown" data-bs-offset="0, 0">
                                            <span class="btn btn-icon" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" title="Pick Template">
                                    ...
                                    <div class="dropdown">
                                        <a href="javascript:void(0)" data-bs-toggle="dropdown" data-bs-offset="0, 0">
                                            <span class="btn btn-icon" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" title="Upload Attachments">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="dropdown me-2">
                                        <a href="javascript:void(0)" data-bs-toggle="dropdown" data-bs-offset="0, -1">
                                            <span class="btn btn-icon" data-bs-toggle="tooltip"
                                                data-bs-trigger="hover" title="Editing Actions">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-icon" data-bs-toggle="tooltip"
                                        data-bs-trigger="hover" title="Discard Message">
                                        <i class="feather-x"></i>
                                    </a>
                                </div>
                            </div>
