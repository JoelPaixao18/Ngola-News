@extends('admin.payment.invoiceCreate.layout.main')
                                ...
                                <div class="d-md-flex align-items-center justify-content-between">
                                    <div class="mb-4 mb-md-0 your-brand">
                                        <div
                                            ...
                                            <img src="{{ url('assets/images/logo-abbr.png') }}"
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-justified gap-1">
                                <li class="nav-item border border-gray-500">
                                    <a href="javascript:void(0);" class="nav-link px-2 active" data-bs-toggle="tab"
                                ...
                                <li class="nav-item border border-gray-500">
                                    <a href="javascript:void(0);" class="nav-link px-2" data-bs-toggle="tab"
                            ...
                            <div class="tab-content mt-4">
                                ...
                                <div class="tab-pane fade" id="pamymetPaypalTab" role="tabpanel">
                                    ...
                                    <div class="fs-11 text-muted">Note: There are many variations of passages of Lorem
                                        ...
                                        humour, or randomised words.</div>
                                </div>
                            </div>
                        </div>
                    </div>
