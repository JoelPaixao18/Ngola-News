...
<body>
    ...
    @include('admin.leads.leadsCreate.parcial.header')
    @include('admin.leads.leadsCreate.parcial.menu')
    <main class="nxl-container">
        @yield('content-leads')
        @include('admin.leads.leadsCreate.parcial.footer')
    </main>
    @include('admin.leads.leadsCreate.parcial.thema')
