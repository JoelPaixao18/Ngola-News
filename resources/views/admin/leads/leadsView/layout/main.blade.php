...
<body>
    ...
    @include('admin.leads.leadsView.parcial.header')
    @include('admin.leads.leadsView.parcial.menu')
    <main class="nxl-container">
        @yield('content-leads')
        @include('admin.leads.leadsView.parcial.footer')
    </main>
    @include('admin.leads.leadsView.parcial.thema')
