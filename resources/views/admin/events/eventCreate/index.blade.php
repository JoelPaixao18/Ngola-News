                                ...
                                <div class="card-body lead-status">
                                    <div class="mb-5 d-flex align-items-center justify-content-between">
                                        <h5 class="fw-bold mb-0 me-4">
                                            <span class="d-block mb-2">Event Status :</span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 mb-4">
                                            ...
                                            <select class="form-control" data-select2-selector="status">
                                                ...
                                                <option value="teal" data-bg="bg-teal">Desport</option>
                                                <option value="warning" data-bg="bg-warning">Politic</option>
                                                <option value="success" data-bg="bg-success">Helth</option>
                                                <option value="danger" data-bg="bg-danger">War</option>
                                                <option value="indigo" data-bg="bg-indigo">International</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-4 mb-4">
